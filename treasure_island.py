...
if choice1 == "left":
  ...
  if choice2=="wait":
    choice3 =input("You arrive ad the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?\n").lower()
    if choice3 == "red":
      print("It is a room full of ire. Game Over.")
    elif choice3 == "yellow":
